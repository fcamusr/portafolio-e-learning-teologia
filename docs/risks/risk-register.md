...
|---|---|---|---|---|---|---|---|---|---|
| R-001 | El proyecto ya tiene un primer endpoint de negocio, pero la API del dominio todavia es incompleta, lo que puede retrasar la primera experiencia funcional completa. | alcance / API | Alto | Alta | Alto | Priorizar contratos minimos faltantes para `Course`, `Unit`, `Lesson` y `LessonProgress` segun `product/` y `api/`. | backend | Abierto | [../product/mvp.md](../product/mvp.md), [../api/overview.md](../api/overview.md) |
